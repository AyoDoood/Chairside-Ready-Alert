...
$sourceScript = Join-Path $packageDir "dental_messenger.py"
...
if (-not (Test-Path $sourceScript)) {
    throw "Missing dental_messenger.py in installer package."
}
...
Copy-Item -Path $sourceScript -Destination (Join-Path $installDir "dental_messenger.py") -Force
